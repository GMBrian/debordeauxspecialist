...
<div id="tribe-events-event-meta" itemscope itemtype="http://schema.org/Event">
	<dl class="column">
		<dt class="event-label event-label-name"><?php _e('Activiteit:', 'tribe-events-calendar'); ?></dt>
      ...
      <?php elseif (tribe_get_organizer()): ?>
		...
		<?php endif; ?>
		<dt class="event-label event-label-updated"><?php _e('Bijgewerkt:', 'tribe-events-calendar'); ?></dt>
	...
	<!--<dl class="column" itemprop="location" itemscope itemtype="http://schema.org/Place">-->
		...
		<dt class="event-label event-label-venue"><?php _e('Locatie:', 'tribe-events-calendar'); ?></dt> 
	...
	<?php if( tribe_address_exists( get_the_ID() ) ) { echo "<div class='body-shadow google-embed'>".tribe_get_embedded_map()."</div>"; } ?>
</div>
