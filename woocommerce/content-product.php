...
<li <?php post_class( $classes ); ?>>
	...
	<h3><a title="<?php the_title(); ?>" href="<?php the_permalink(); ?>"><?php the_title(); ?></a> <?php the_product_grape_icon(); ?> <?php woocommerce_template_loop_rating(); ?></h3>
	...
	<?php
        ...
        add_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_single_meta', 15 );
	...
	<?php 
		//add_action( 'woocommerce_after_shop_loop_item', 'the_cleardiv', 100 );
		
		// Bevat de add_to_cart functie
